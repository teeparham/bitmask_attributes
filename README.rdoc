...
Find records without specific attributes:
    ...
    User.without_roles(:editor, :writer)
    # => (all users who are neither editors nor writers)

Note that "without_" supports arguments, and the "no_" method does not support arguments.
